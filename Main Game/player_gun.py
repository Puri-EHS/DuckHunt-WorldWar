...
class PlayerGun:
    def __init__(self):
        ...
        self.shoot_sound = pygame.mixer.Sound("Main Game/shoot.mp3")

        self.crosshair = pygame.image.load("Main Game/crosshair.png").convert_alpha()
        ...
        self.idle_images.append(Spritesheet("Main Game/gun.png").image_at((128*2, 0, 128, 120)))
        self.idle_images[0] = pygame.transform.flip(self.idle_images[0], True, False)
        self.idle_images.append(Spritesheet("Main Game/gun.png").image_at((0, 0, 128, 120)))
        self.idle_images.append(Spritesheet("Main Game/gun.png").image_at((128*2, 0, 128, 120)))

        self.shoot_images.append(Spritesheet("Main Game/gun.png").image_at((128*4, 0, 128, 120)))
        self.shoot_images[0] = pygame.transform.flip(self.shoot_images[0], True, False)
        self.shoot_images.append(Spritesheet("Main Game/gun.png").image_at((128*3, 0, 128, 120)))
        self.shoot_images.append(Spritesheet("Main Game/gun.png").image_at((128*4, 0, 128, 120)))
