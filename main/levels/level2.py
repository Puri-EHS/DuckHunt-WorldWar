...
from constants import OUTBACK, OUTBACK_BUSH_BACK, OUTBACK_BUSH_FRONT, HIT_BAR_FRAME, HIT_BAR, HIT_EFFECT, AMMO_4, DUCKCROSSHAIR, HITBOX
...
class Level2(Level):
    def __init__(self, _name, _screen, _game_instance):
        ...
        self.images = [
            ImageObj(OUTBACK_BUSH_BACK, 5, 2100, 700, y_pos=450),
